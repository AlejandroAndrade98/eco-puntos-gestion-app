...
const Localidades = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    let result;
    if (currentLocalidad?.idLocalidad) {
      result = await localidadesApi.update(currentLocalidad.idLocalidad, formData as Localidad);
      if (result) {
        setLocalidades(
          localidades.map(l => 
      ...
      // For new records, we don't need to provide idLocalidad as it will be generated by the server
      result = await localidadesApi.create(formData as Localidad);
      if (result) {
